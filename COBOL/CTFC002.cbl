      ...
      *===============================================================*
       R001-INIT SECTION.
           ...
           IF SW-CONT-FOUND
              ...
              MOVE P-CHAR(1:W-CONT-LENGTH) TO W-LCTFM002
           END-IF
      ...
      *===============================================================*
      * R005-CALL-CTFM002: Call CTFM002                               *
      *===============================================================*
       R005-CALL-CTFM002 SECTION.
           MOVE 'CTFM002' TO W-PGMNAME

           CALL W-PGMNAME USING W-LCTFM002
           .
       R005-CALL-CTFM002-END.
           EXIT.
      ...
      *===============================================================*
       R009-FINISH SECTION.
           MOVE C-CHNL-NAME-LWW      TO W-CHNL-NAME 
           MOVE C-CONT-NAME-LWW-03   TO W-CONT-NAME
           MOVE LENGTH OF W-LCTFM002 TO W-CONT-LENGTH
           SET W-CONT-POINTER TO ADDRESS OF W-LCTFM002
